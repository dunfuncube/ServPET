...
//    @Column(name = "ADMIN_ID", nullable = true)
	private PlatformAdminVO adminId;
	...
	public CsIssueVO(Integer csQaId, MebVO mebId, PlatformAdminVO adminId, String qaContent, LocalDateTime qaDate,
	...
	public PlatformAdminVO getAdminId() {
		return adminId;
	}

	public void setAdminId(PlatformAdminVO adminId) {
		this.adminId = adminId;
	}
